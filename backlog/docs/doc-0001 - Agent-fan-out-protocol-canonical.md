...
> This in-repo copy is authoritative for this repository - it is what an agent with only the
> checkout, in CI or on another machine, will read. It has not been summarised, compressed or
> adapted. When the source file changes, the edit is not finished until this copy has been
