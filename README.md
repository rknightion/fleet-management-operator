...
| [PipelineDiscovery](docs/samples.md#pipelinediscovery-import-alloy-pipelines) | Import Fleet Management pipelines as Kubernetes Pipeline CRs |
...
- cert-manager, or a manually managed webhook serving certificate and CA bundle
