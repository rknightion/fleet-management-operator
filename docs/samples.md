...
Source: [config/samples/collector_sample.yaml](https://github.com/rknightion/fleet-management-operator/blob/main/config/samples/collector_sample.yaml)
...
Source: [config/samples/collector_discovery_sample.yaml](https://github.com/rknightion/fleet-management-operator/blob/main/config/samples/collector_discovery_sample.yaml)
...
Source: [config/samples/external_sync_sample.yaml](https://github.com/rknightion/fleet-management-operator/blob/main/config/samples/external_sync_sample.yaml)
...
Source: [config/samples/alloy_pipeline_sample.yaml](https://github.com/rknightion/fleet-management-operator/blob/main/config/samples/alloy_pipeline_sample.yaml)
...
Source: [config/samples/pipeline_otel_sample.yaml](https://github.com/rknightion/fleet-management-operator/blob/main/config/samples/pipeline_otel_sample.yaml)
...
Source: [config/samples/pipeline_discovery_sample.yaml](https://github.com/rknightion/fleet-management-operator/blob/main/config/samples/pipeline_discovery_sample.yaml)
...
Source: [config/samples/policy_sample.yaml](https://github.com/rknightion/fleet-management-operator/blob/main/config/samples/policy_sample.yaml)
...
Source: [config/samples/tenant_policy_sample.yaml](https://github.com/rknightion/fleet-management-operator/blob/main/config/samples/tenant_policy_sample.yaml)
